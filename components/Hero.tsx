...
export default function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-80px)] bg-[#FFFCFA] overflow-hidden">
      {/* Soft background grid */}
      <div className="absolute inset-0 bg-[radial-gradient(#D4AF37_1px,transparent_1px)] [background-size:32px_32px] opacity-[0.04]" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-4 sm:pt-6 md:pt-8 lg:pt-10 pb-16 sm:pb-20 md:pb-24 lg:pb-28 grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-center">
        {/* ================= LEFT CONTENT ================= */}
        <motion.div
          variants={container}
          initial="hidden"
        ...
        >
          ...
          <motion.h1
            variants={item}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[78px] font-serif text-gray-900 leading-[1.1]"
          >
            Dentistry Crafted
            <br />
            <span className="text-[#C21E56] font-light">
          ...
          >
            <Link
              href="/contact"
              className="px-8 sm:px-10 py-4 sm:py-5 rounded-full bg-[#C21E56] text-white text-[10px] sm:text-[11px] font-bold tracking-widest uppercase hover:bg-[#A01845] transition-all text-center"
            >
              Book Consultation
            </Link>
            ...
            <Link
              href="/services"
              className="flex items-center justify-center gap-2 px-8 sm:px-10 py-4 sm:py-5 rounded-full border border-gray-200 text-gray-900 text-[10px] sm:text-[11px] font-bold tracking-widest uppercase hover:bg-gray-50 transition-all group"
            >
              View Treatments
          ...
          <motion.div variants={item} className="flex gap-6 pt-4 text-gray-400">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative w-full max-w-[520px] mx-auto aspect-[3/4] overflow-hidden rounded-2xl border border-gray-200 shadow-[0_40px_90px_-30px_rgba(0,0,0,0.15)]">
            <Image
              src="/hero.jpg"
              alt="Tooth Stories Dental Clinic"
              fill
          ...
          <motion.div
            ...
            className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-xl p-4 rounded-xl border border-gray-100 shadow-lg"
          >
