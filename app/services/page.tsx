...
//     category: "Cosmetic",
//     description:
//       "A comprehensive approach to transforming your smile using veneers, bonding, and whitening.",
...
//     category: "General",
//     description:
//       "Comprehensive examinations and professional cleanings to maintain your long-term oral health.",
...
//     description:
//       "Discreetly straighten your teeth with custom-made, clear aligners designed for comfort.",
...
//     description:
//       "The gold standard for tooth replacement, offering a permanent and natural-looking solution.",
...
//     step: "01",
//     title: "Consultation",
//     desc: "A relaxed conversation to understand your goals and dental history.",
//     icon: <Coffee size={24} />,
//   },
//   {
//     step: "02",
//     title: "Digital Scan",
//     desc: "Using high-precision 3D imaging for a detailed map of your smile.",
//     icon: <Microscope size={24} />,
//   },
//   {
//     step: "03",
//     title: "Treatment",
//     desc: "Precise execution using minimally invasive dental techniques.",
...
//           <div className="max-w-7xl mx-auto border-b border-gray-100 pb-20">
//             <motion.div
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               className="max-w-3xl"
//             >
//               <span className="text-[11px] font-bold uppercase tracking-[0.4em] text-[#C21E56] block mb-6">
//                 Elite Dental Solutions
//               </span>
//               <h1 className="text-5xl md:text-8xl font-serif text-gray-900 leading-[0.9] mb-8">
//                 Excellence <br />
...
//                 We provide a curated selection of dental treatments designed to
//                 restore function and enhance the natural beauty of your smile.
//               </p>
//             </motion.div>
//           </div>
//         </section>
...
//                     className="group bg-white rounded-[40px] overflow-hidden border border-gray-100 flex flex-col md:flex-row h-full"
//                   >
...
//                       <div className="text-[#C21E56] mb-4">{service.icon}</div>
...
//                         {service.description}
//                       </p>
//                       <button className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#D4AF37] hover:text-[#C21E56] transition-colors">
...
//                 The Tooth Stories Method
//               </h2>
//             </div>
//             <div className="grid md:grid-cols-3 gap-16">
//               {processes.map((p) => (
//                 <div key={p.step} className="relative text-center group">
//                   <div className="text-[80px] font-serif text-gray-50 absolute -top-12 left-1/2 -translate-x-1/2 z-0">
//                     {p.step}
//                   </div>
//                   <div className="relative z-10">
//                     <div className="w-16 h-16 bg-[#FFFCFA] border border-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-6 text-[#C21E56] group-hover:bg-[#C21E56] group-hover:text-white transition-all duration-500">
//                       {p.icon}
//                     </div>
//                     <h4 className="text-xl font-serif text-gray-900 mb-4">
//                       {p.title}
//                     </h4>
//                     <p className="text-gray-500 font-light text-sm leading-relaxed max-w-[250px] mx-auto">
//                       {p.desc}
//                     </p>
//                   </div>
//                 </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                <h1 className="text-6xl md:text-8xl lg:text-[110px] font-serif text-gray-900 leading-[0.85] tracking-tight max-w-4xl">
                  Excellence <br />
                  <span className="italic font-light text-[#D4AF37] relative">
                    In Every Detail
                    <svg
